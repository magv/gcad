...
def test_gluza_ex33():
    ...
    # Above threshold
    MT, x0, x1, x2, x3, x4, x5, x6, x7 = sp.symbols("MT x0 x1 x2 x3 x4 x5 x6 x7")
    F = + (MT**2)*x5*x6*x7**2 + (MT**2)*x5*x6**2*x7 + (2*MT**2 - 10)*x4*x5*x6*x7 + (MT**2)*x4*x5*x6**2 + (MT**2)*x4**2*x5*x6 + (MT**2)*x3*x6*x7**2 + (MT**2)*x3*x6**2*x7 + (MT**2)*x3*x5*x7**2 + (2*MT**2 - 10)*x3*x5*x6*x7 + (MT**2)*x3*x5*x6**2 + (2*MT**2 - 10)*x3*x4*x6*x7 + (MT**2)*x3*x4*x6**2 + (2*MT**2 - 10)*x3*x4*x5*x7 + (2*MT**2)*x3*x4*x5*x6 + (MT**2)*x3*x4**2*x6 + (MT**2)*x3*x4**2*x5 + (MT**2)*x2*x6*x7**2 + (MT**2)*x2*x6**2*x7 + (2*MT**2)*x2*x5*x6*x7 + (MT**2)*x2*x5*x6**2 + (2*MT**2 - 10)*x2*x4*x6*x7 + (MT**2)*x2*x4*x6**2 + (2*MT**2 - 10)*x2*x4*x5*x6 + (MT**2)*x2*x4**2*x6 + (MT**2)*x2*x3*x7**2 + (2*MT**2 - 10)*x2*x3*x6*x7 + (2*MT**2)*x2*x3*x5*x7 + (2*MT**2 - 10)*x2*x3*x5*x6 + (2*MT**2 - 10)*x2*x3*x4*x7 + (2*MT**2 - 10)*x2*x3*x4*x6 + (2*MT**2 - 10)*x2*x3*x4*x5 + (MT**2)*x2*x3*x4**2 + (MT**2)*x2**2*x6*x7 + (MT**2)*x2**2*x5*x6 + (MT**2)*x2**2*x4*x6 + (MT**2)*x2**2*x3*x7 + (MT**2)*x2**2*x3*x5 + (MT**2)*x2**2*x3*x4 + (MT**2)*x1*x6*x7**2 + (MT**2)*x1*x6**2*x7 + (MT**2)*x1*x5*x7**2 + (2*MT**2)*x1*x5*x6*x7 + (2*MT**2 - 10)*x1*x4*x6*x7 + (MT**2)*x1*x4*x6**2 + (2*MT**2 - 10)*x1*x4*x5*x7 + (2*MT**2)*x1*x4*x5*x6 + (MT**2)*x1*x4**2*x6 + (MT**2)*x1*x4**2*x5 + (2*MT**2 - 10)*x1*x3*x6*x7 + (MT**2)*x1*x3*x6**2 + (2*MT**2 - 10)*x1*x3*x5*x7 + (2*MT**2)*x1*x3*x5*x6 + (2*MT**2)*x1*x3*x4*x6 + (2*MT**2)*x1*x3*x4*x5 + (MT**2)*x1*x2*x7**2 + (4*MT**2)*x1*x2*x6*x7 + (MT**2)*x1*x2*x6**2 + (2*MT**2)*x1*x2*x5*x7 + (2*MT**2)*x1*x2*x5*x6 + (2*MT**2 - 10)*x1*x2*x4*x7 + (4*MT**2 - 10)*x1*x2*x4*x6 + (2*MT**2 - 10)*x1*x2*x4*x5 + (MT**2)*x1*x2*x4**2 + (2*MT**2 - 10)*x1*x2*x3*x7 + (2*MT**2 - 10)*x1*x2*x3*x6 + (2*MT**2 - 10)*x1*x2*x3*x5 + (2*MT**2)*x1*x2*x3*x4 + (MT**2)*x1*x2**2*x7 + (MT**2)*x1*x2**2*x6 + (MT**2)*x1*x2**2*x5 + (MT**2)*x1*x2**2*x4 + (MT**2)*x1*x2**2*x3 + (MT**2)*x1**2*x6*x7 + (MT**2)*x1**2*x5*x7 + (MT**2)*x1**2*x4*x6 + (MT**2)*x1**2*x4*x5 + (MT**2)*x1**2*x3*x6 + (MT**2)*x1**2*x3*x5 + (MT**2)*x1**2*x2*x7 + (MT**2)*x1**2*x2*x6 + (MT**2)*x1**2*x2*x5 + (MT**2)*x1**2*x2*x4 + (MT**2)*x1**2*x2*x3 + (MT**2)*x0*x5*x7**2 + (2*MT**2 - 10)*x0*x5*x6*x7 + (2*MT**2 - 10)*x0*x4*x5*x7 + (2*MT**2 - 10)*x0*x4*x5*x6 + (MT**2)*x0*x4**2*x5 + (MT**2)*x0*x3*x7**2 + (2*MT**2 - 10)*x0*x3*x6*x7 + (2*MT**2)*x0*x3*x5*x7 + (2*MT**2 - 10)*x0*x3*x5*x6 + (2*MT**2 - 10)*x0*x3*x4*x7 + (2*MT**2 - 10)*x0*x3*x4*x6 + (2*MT**2 - 10)*x0*x3*x4*x5 + (MT**2)*x0*x3*x4**2 + (MT**2)*x0*x2*x7**2 + (2*MT**2 - 10)*x0*x2*x6*x7 + (2*MT**2)*x0*x2*x5*x7 + (2*MT**2 - 10)*x0*x2*x5*x6 + (2*MT**2 - 10)*x0*x2*x4*x7 + (2*MT**2 - 10)*x0*x2*x4*x6 + (2*MT**2 - 10)*x0*x2*x4*x5 + (MT**2)*x0*x2*x4**2 + (2*MT**2)*x0*x2*x3*x7 + (2*MT**2)*x0*x2*x3*x5 + (2*MT**2)*x0*x2*x3*x4 + (MT**2)*x0*x2**2*x7 + (MT**2)*x0*x2**2*x5 + (MT**2)*x0*x2**2*x4 + (MT**2)*x0*x1*x7**2 + (2*MT**2 - 10)*x0*x1*x6*x7 + (2*MT**2 - 10)*x0*x1*x5*x7 + (2*MT**2 - 10)*x0*x1*x4*x7 + (2*MT**2 - 10)*x0*x1*x4*x6 + (2*MT**2 - 10)*x0*x1*x4*x5 + (MT**2)*x0*x1*x4**2 + (2*MT**2 - 10)*x0*x1*x3*x7 + (2*MT**2 - 10)*x0*x1*x3*x6 + (2*MT**2 - 10)*x0*x1*x3*x5 + (2*MT**2)*x0*x1*x3*x4 + (4*MT**2 - 10)*x0*x1*x2*x7 + (2*MT**2 - 10)*x0*x1*x2*x6 + (2*MT**2 - 10)*x0*x1*x2*x5 + (4*MT**2)*x0*x1*x2*x4 + (2*MT**2)*x0*x1*x2*x3 + (MT**2)*x0*x1*x2**2 + (MT**2)*x0*x1**2*x7 + (MT**2)*x0*x1**2*x4 + (MT**2)*x0*x1**2*x3 + (MT**2)*x0*x1**2*x2 + (MT**2)*x0**2*x5*x7 + (MT**2)*x0**2*x4*x5 + (MT**2)*x0**2*x3*x7 + (MT**2)*x0**2*x3*x5 + (MT**2)*x0**2*x3*x4 + (MT**2)*x0**2*x2*x7 + (MT**2)*x0**2*x2*x5 + (MT**2)*x0**2*x2*x4 + (MT**2)*x0**2*x1*x7 + (MT**2)*x0**2*x1*x4 + (MT**2)*x0**2*x1*x3 + (MT**2)*x0**2*x1*x2
    F = F.subs({MT:1})
    problem1 = [ F < 0, x0 > 0, x1 > 0, x2 > 0, x3 > 0, x4 > 0, x5 > 0, x6 > 0, x7 > 0]
    problem2 = [ F > 0, x0 > 0, x1 > 0, x2 > 0, x3 > 0, x4 > 0, x5 > 0, x6 > 0, x7 > 0]
    variables = [[x0, x1, x2, x3, x4, x5, x6, x7]]
